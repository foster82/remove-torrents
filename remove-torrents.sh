...
echo "Completed Torrents" | mutt  -s  "Completed torrents" XX@gmail.com -a /home/pi/completed$(date +%F).txt

TORRENTLIST=`$REMOTE --list | sed -e '1d;$d;s/^ *//'  | cut --only-delimited --delimiter=" " --fields=1 | tr -d '*'` 
